...
public final class FindMeetingQueryTest {
  ...
  @Test 
  public void optinalAttendeeWithAllDayEvent() {
    //optional attendee C has an all-day event -- the same time slots should be returned
    //as would be if that attendee wasn't there
  ...
  @Test 
  public void optinalAttendeeWithEventThatFits() {
    //optional attendee C who has a meeting but still is able to make it to a meeting
    //should be included
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
  ...
  public void justEnoughRoomForOptionalAttendee() {
    //optional attendee B has a meething but has just enough room to make it
    //to the meeting where A could make it
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
  ...
  @Test
  public void optionalAttendessWithGaps() {
    //Only optional attendees in this one, they have space in their schedule
    //so they should be able to attend
    Collection<Event> events = Arrays.asList (
  ...
  @Test
  public void optionalAttendesWithoutGaps() {
    //Only optional attendees again, but this time they don't have gaps in their
    //schedule, so no time should be available
    Collection<Event> events = Arrays.asList (
